...
public class GenreHome {
	...
	public Genre merge(Genre detachedInstance) {
		...
		try {
			Genre result = (Genre) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Genre findById(java.lang.String id) {
		...
		try {
			Genre instance = (Genre) sessionFactory.getCurrentSession().get(
					"test.Genre", id);
			if (instance == null) {
	...
	public List findByExample(Genre instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("test.Genre").add(Example.create(instance))
					.list();
