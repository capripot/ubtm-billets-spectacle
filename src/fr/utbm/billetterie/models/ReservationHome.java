...
public class ReservationHome {
	...
	public Reservation merge(Reservation detachedInstance) {
		...
		try {
			Reservation result = (Reservation) sessionFactory
	...
	public Reservation findById(int id) {
		...
		try {
			Reservation instance = (Reservation) sessionFactory
					.getCurrentSession().get("test.Reservation", id);
			if (instance == null) {
	...
	public List findByExample(Reservation instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("test.Reservation")
